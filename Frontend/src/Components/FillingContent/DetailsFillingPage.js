...
function DetailsFillingWritter() {
                    ...
                    <div className=" col-lg-3 col-sm-12 col-12 sidebar"  >
                            <li className="list-item" onClick={onSideNavLinkClick}>
                              {/* condition is applied to the Link when 'isFormValid'=== true, then the link is active and directs the user to the next page otherwise the link is inactive */}
                                <Link to = {isFormValid?"/fillingWritter/personalinfo":'#'} className='no-text-decoration'>
                                  Personal Info
                                </Link>
                            </li>
                            <li className=" list-item" onClick={onSideNavLinkClick}>
                                <Link to = {isFormValid?"/fillingWritter/education":'#'} className='no-text-decoration'>
                                  Education
                                </Link>
                            </li>
                    </div>
...
export default DetailsFillingWritter